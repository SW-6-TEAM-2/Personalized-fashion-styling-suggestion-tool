...
export default function Navbar() {
  ...
  return (
    <nav
      ...
      style={{ backgroundColor: '#ffffff', borderBottom: '1px solid #e8e8e8', padding: '14px 40px' }}
    >
      {/* 로고 */}
      <span
        className="font-logo cursor-pointer"
        style={{ fontSize: 26, fontWeight: 600, color: '#111111' }}
        onClick={() => navigate('/')}
      >
        dailycloset
      </span>
      ...
      <div className="flex items-center gap-8">
        ...
        <button
          ...
          style={{
            ...
            background: 'none',
            border: 'none',
            borderBottom: isActive('/ootd') ? '2px solid #ff6b35' : '2px solid transparent',
            paddingBottom: 2,
          }}
        >
          OOTD
        ...
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
            ...
            <path d="M4 20c0-4 3.6-7 8-7s8 3 8 7" stroke="#111111" strokeWidth="1.5" strokeLinecap="round" />
          </svg>
        </button>
      </div>
    </nav>
